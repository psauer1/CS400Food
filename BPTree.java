...
public class BPTree<K extends Comparable<K>, V> implements BPTreeADT<K, V> {
	...
	/**
	 * This method reveals if the root node has been initialized. It returns true
	...
	/**
	 * Private recursive helper method for public insert method above. This method
	 * finds the proper leaf node to insert the new key and value into.
	 * 
	 * @param key
	 *            to insert
	 * @param value
	 *            to insert
	 * @param reference
	 *            to the current node in tree traversal
	 */
	...
	/**
	 * Finds the parent of an internal node
	 * 
	 * @param current
	 * @param leaf
	 * @return InternalNode
